...
# ============================================================
# 4) بطاقات حلويات اللوز (8 بطاقات)
# ============================================================
...
RECIPES_SEMOLINA = [
    ...
    # 1. المبرجة
    {
        ...
        "topping": "",
        "preparation": "يُعجن السميد بالسمن والزيت والملح والماء، يُفرد ويحشى بالتمر، يُقطع مربعات ويُطهى على الطاجين حتى يصبح ذهبياً.",
        "cooking": "طهي على الطاجين لمدة 20 دقيقة حتى الذهبية.",
        "secrets": "",
        "common_mistakes": "العجينة جافة → أضيفي ماء. الحشو يخرج → اضغطي جيداً على الأطراف.",
        "storage": "في علبة محكمة.",
        "shelf_life": "5 أيام."
    },
    ...
    # 6. المعمول
    {
        ...
        "secrets": "",
        "common_mistakes": "يتفتت → أضيفي زبدة. الحشو يخرج → أغلقِ جيداً.",
        "storage": "في علبة محكمة.",
        "shelf_life": "أسبوع."
    },
    ...
    # 7. الرفيس القسنطيني
    {
        "id": "r_rafis_constantine",
        "title": "الرفيس القسنطيني",
        "category": "حلويات السميد",
        ...
        "preparation": "يُحمّص السميد، يُضاف الزبدة، يُسكب العسل تدريجياً، يُعطر بالقرفة والقرنفل، يُزين بالمكسرات.",
    ...
    "programs": [
            ...
            "modules": [
                {
                    ...
                    "objective": "تمكين المتربص من تطبيق قواعد النظافة الشخصية ونظافة الورشة واستعمال التجهيزات بأمان.",
                    "lessons": [
                        {
                            "id": "app_l1",
                            "title": "النظافة الشخصية والمهنية",
                            "objective": "التعرف على قواعد النظافة الواجب احترامها قبل وأثناء العمل.",
                            "content": "تشمل النظافة الشخصية غسل اليدين بطريقة صحيحة، ارتداء اللباس المهني، تغطية الشعر، المحافظة على نظافة الأظافر، وعدم استعمال الحلي أثناء العمل.",
                            "activities": ["مناقشة أخطار عدم احترام النظافة.", "تطبيق عملي لغسل اليدين.", "فحص اللباس المهني."]
                        },
                        {
                            "id": "app_l2",
                            "title": "تنظيم منصب العمل",
                            "objective": "تعلم تنظيم الأدوات والمواد قبل بداية العمل.",
                            "content": "يتم تنظيم منصب العمل حسب طبيعة الإنتاج، ووضع الأدوات الضرورية في أماكن يسهل الوصول إليها، مع المحافظة على حركة آمنة داخل الورشة.",
                            "activities": ["تحديد الأدوات الضرورية.", "ترتيب منصب العمل.", "تنظيف المنصب بعد الانتهاء."]
                        }
                    ],
                    "recipes": []
                },
                {
                    "id": "app_m2",
                    "title": "الوحدة 02: المواد الأولية",
                    "objective": "التعرف على خصائص المواد الأساسية المستعملة في صناعة الحلويات.",
                    "lessons": [
                        {
                            "id": "app_l3",
                            "title": "الدقيق والسميد",
                            "objective": "التمييز بين أنواع الدقيق والسميد واختيار المناسب لكل تحضير.",
                            "content": "الدقيق مصدر أساسي للنشاء والبروتين، بينما يختلف السميد حسب درجة الطحن والاستعمال. يجب اختيار المادة وفق طبيعة المنتج النهائي.",
                            "activities": ["مقارنة أنواع الدقيق.", "التعرف على السميد.", "ربط المادة بالمنتج المناسب."]
                        },
                        {
                            "id": "app_l4",
                            "title": "السكر والدهون",
                            "objective": "معرفة وظائف السكر والدهون في المنتجات.",
                            "content": "يساهم السكر في الحلاوة واللون والقوام، بينما تؤثر الدهون في الطراوة والهشاشة والطعم.",
                            "activities": ["مقارنة الزبدة والسمن.", "دراسة تأثير السكر.", "تطبيق على وصفة بسيطة."]
                        }
                    ],
                    "recipes": []
                }
        ...
        # ================= البرنامج الحضوري =================
        {
            ...
            "modules": [
                {
                    "id": "ft_m1",
                    "title": "الوحدة 01: التكنولوجيا الغذائية",
                    "objective": "دراسة المواد الأولية وخصائصها وتفاعلاتها أثناء التحضير والطهي.",
                    "lessons": [
                        {
                            "id": "ft_l1",
                            "title": "خصائص الدقيق",
                            "objective": "فهم دور الدقيق في تكوين العجائن.",
                            "content": "تختلف خصائص الدقيق حسب نسبة البروتين ودرجة الطحن والرطوبة. اختيار الدقيق يؤثر مباشرة على بنية المنتج النهائي.",
                            "activities": ["ملاحظة أنواع الدقيق.", "تحديد الاستعمال المناسب.", "تحليل نتيجة التحضير."]
                        },
                        {
                            "id": "ft_l2",
                            "title": "البيض في صناعة الحلويات",
                            "objective": "معرفة الوظائف التقنية للبيض.",
                            "content": "يستعمل البيض للربط والاستحلاب والرغوة وإضافة اللون والقيمة الغذائية.",
                            "activities": ["فصل مكونات البيض.", "تحضير رغوة البياض.", "دراسة تأثير الحرارة."]
                        }
                    ],
                    "recipes": []
                },
                {
                    "id": "ft_m2",
                    "title": "الوحدة 02: العجائن الأساسية",
                    "objective": "إتقان تحضير أهم العجائن المستخدمة في صناعة الحلويات.",
                    "lessons": [
                        {
                            "id": "ft_l3",
                            "title": "العجينة المكسرة",
                            "objective": "تحضير عجينة مكسرة متجانسة وهشة.",
                            "content": "تخلط الدهون مع الدقيق بطريقة مناسبة ثم تضاف السوائل حسب الوصفة، مع تجنب الإفراط في العجن.",
                            "activities": ["وزن المواد.", "تحضير العجينة.", "الراحة.", "التوريق والتشكيل."]
                        },
                        {
                            "id": "ft_l4",
                            "title": "العجينة المورقة",
                            "objective": "فهم مبدأ التوريق والطبقات.",
                            "content": "تعتمد العجينة المورقة على تكوين طبقات متناوبة من العجين والدهون، وتحتاج إلى التحكم في درجة الحرارة وعدد الطيات.",
                            "activities": ["تحضير العجين.", "إدخال الدهون.", "إنجاز الطيات.", "الطهي."]
                        }
                    ],
                    "recipes": []
                }
            ...
            "subPrograms": [
                # =========== الحلويات التقليدية ===========
                {
                    ...
                    "modules": [
                            ...
                            "lessons": [
                                {
                                    ...
                                    "content": "تمزج مكونات عجينة اللوز تدريجياً مع التحكم في كمية السائل حتى الحصول على قوام متماسك قابل للتشكيل.",
                                    "activities": ["وزن اللوز والسكر.", "إضافة السائل تدريجياً.", "اختبار القوام.", "تلوين العجينة عند الحاجة."]
                                },
                                {
                                    "id": "tr_l2",
                                    "title": "التشكيل والتزيين",
                                    "objective": "تطوير الدقة في تشكيل الحلويات.",
                                    "content": "يعتمد نجاح التشكيل على تجانس العجينة ودقة الوزن واستعمال الأدوات المناسبة.",
                                    "activities": ["تقسيم العجينة.", "التشكيل اليدوي.", "التزيين.", "تنظيم المنتجات."]
                                }
                            ],
                        ...
                        },
                        {
                            ...
                            "objective": "إتقان تحضير 7 حلويات تقليدية معتمدة على السميد والمعسلات.",
                            "lessons": [
                                {
                                    "id": "tr_l3",
                                    "title": "تقنيات تبسيس السميد",
                                    "objective": "تعلم التعامل الصحيح مع السميد والدهون والسائل.",
                                    "content": "تحتاج عجائن السميد إلى عملية تبسيس جيدة حتى تتوزع الدهون داخل حبيبات السميد، ثم تتم إضافة السائل تدريجياً دون إفراط في العجن.",
                                    "activities": ["وزن السميد.", "إضافة الدهون.", "عملية التبسيس.", "إضافة السائل.", "الراحة."]
                                },
                                {
                                    "id": "tr_l4",
                                    "title": "تقنيات القلي والسقي",
                                    "objective": "التحكم في عملية القلي والسقي.",
                                    "content": "يجب التحكم في درجة حرارة الزيت وتوقيت السقي للحصول على منتج متماسك ومتشرب بطريقة متوازنة.",
                                    "activities": ["تسخين الزيت.", "اختبار الحرارة.", "القلي.", "التصفية.", "السقي."]
                                }
                            ],
                        ...
                        {
                            "id": "tr_m3",
                            "title": "المقياس 03: التقييم والتطبيق الشامل",
                            "objective": "دمج الكفاءات المكتسبة في إنجاز منتج كامل وفق بطاقة تقنية.",
                            "lessons": [
                                {
                                    "id": "tr_l5",
                                    "title": "النشاط التطبيقي الشامل",
                                    "objective": "إنجاز منتج من اختيار المتربص تحت إشراف الأستاذ.",
                                    "content": "يختار المتربص منتجاً مناسباً لمستواه ويقوم بإنجاز جميع مراحل العمل من تحضير المواد إلى التشطيب والتقديم.",
                                    "activities": ["قراءة البطاقة التقنية.", "تجهيز المواد.", "تنظيم منصب العمل.", "الإنتاج.", "التشطيب.", "التقييم الذاتي."]
                                }
                            ],
                            "recipes": []
                        }
                ...
                # =========== الحلويات الشرقية ===========
                {
                    ...
                    "modules": [
                        {
                            "id": "or_m1",
                            "title": "المقياس 01: البقلاوة والحلويات المشرقية",
                            "objective": "التعرف على تقنيات تحضير المنتجات الشرقية.",
                            "lessons": [
                                {
                                    "id": "or_l1",
                                    "title": "تقنيات تحضير الشربات",
                                    "objective": "تحضير شربات متجانس واستعماله بالشكل الصحيح.",
                                    "content": "يعتمد نجاح الشربات على احترام نسب السكر والسائل والتحكم في مدة الطهي والتبريد.",
                                    "activities": ["وزن السكر.", "إضافة الماء.", "الغليان.", "التحكم في القوام.", "التبريد."]
                                },
                                {
                                    "id": "or_l2",
                                    "title": "تقنيات الكنافة",
                                    "objective": "التعرف على المبادئ الأساسية لتحضير الكنافة.",
                                    "content": "تشمل مراحل تحضير الكنافة تجهيز الخيوط أو العجينة، إضافة الدهون والحشوة، الطهي، ثم السقي والتقديم.",
                                    "activities": ["تجهيز الكنافة.", "إضافة الدهون.", "إضافة الحشوة.", "الطهي.", "السقي."]
                                }
                            ],
                            "recipes": []
                        }
                ...
                # =========== الحلويات الغربية ===========
                {
                    ...
                    "modules": [
                        {
                            "id": "we_m1",
                            "title": "المقياس 01: الكيك والكريمات",
                            "objective": "اكتساب المهارات الأساسية في تحضير الكيك والكريمات.",
                            "lessons": [
                                {
                                    "id": "we_l1",
                                    "title": "الكيك الإسفنجي",
                                    "objective": "تحضير قاعدة كيك إسفنجي متجانسة.",
                                    "content": "تعتمد جودة الكيك الإسفنجي على إدخال الهواء والمحافظة على الرغوة وعدم الإفراط في الخلط بعد إضافة الدقيق.",
                                    "activities": ["خفق البيض.", "إضافة السكر.", "إدخال الدقيق.", "وضع الخليط في القالب.", "الخبز."]
                                },
                                {
                                    "id": "we_l2",
                                    "title": "الكريمة الأساسية",
                                    "objective": "التعرف على أنواع الكريمات واستعمالاتها.",
                                    "content": "تختلف الكريمات حسب طريقة التحضير والاستخدام، ومنها الكريمات المطبوخة والكريمة المخفوقة والغاناش.",
                                    "activities": ["تحضير كريمة.", "تبريدها.", "تجهيزها للتزيين.", "تطبيق زخارف بسيطة."]
                                }
                            ],
                            "recipes": []
                        }
...
# ============================================================
# 13) نماذج الإضافة والتعديل للأستاذ
# ============================================================
